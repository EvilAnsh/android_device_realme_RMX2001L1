...
if [ ! -d "device/realme/RM6785-common" ]; then
    ...
    git clone https://github.com/EvilAnsh/android_device_realme_RM6785-common --depth 1 -b sixteen device/realme/RM6785-common
fi
...
if [ ! -d "vendor/realme/RM6785-common" ]; then
    ...
    git clone https://github.com/PixelOS-Devices/vendor_realme_RM6785-common --depth 1 -b sixteen vendor/realme/RM6785-common
fi
...
if [ ! -d "kernel/realme/mt6785" ]; then
    ...
    git clone https://github.com/PixelOS-Devices/kernel_realme_mt6785 --depth 1 -b sixteen kernel/realme/mt6785
fi
